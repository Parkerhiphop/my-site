...
1. Ask myself some big-picture questions first
2. Organize my weekly journals
3. Roughly see what I did every day from the calendar
...
1. Goals and achievements reached this year
2. Unexpected goals and achievements reached
3. Three most valuable lessons
4. Three best decisions
5. Three most adventurous things
6. Three best books
...
(In the next article, I will share how I use Notion to implement this process!)
