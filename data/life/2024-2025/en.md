...
2. First time listening to a concert in Japan
3. **Met Airi Suzuki**, participated in handover event and Live
...
4. First time picking up at the airport (milet Asia tour Taipei stop)
...
6. More practical experience and understanding of WordPress, SEO, Cloudflare, AWS, Caching at work
7. Passed JLPT N2

   Felt that certificates are like this. Even after passing the second to last Japanese test, still feel my Japanese sucks.

8. Worked in Japan office for two weeks
...
3. Didn't make up CS and some knowledge I wanted to learn
4. Didn't maintain weight training habits
...
3. Spent too much time on some pacifier entertainment
...
1. Become an **Open Source Contributor**, currently relying on friends and [Source for You](https://github.com/opensource4you/readme) community help, fortunate to participate in Kafka.
2. Strive to broaden my software engineer career, not limiting myself to frontend.
